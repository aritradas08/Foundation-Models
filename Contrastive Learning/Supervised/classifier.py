# Supervised classification using a single linear layer for supervised contrastive learning case
...
EMBEDDINGS_PATH = "/global/cfs/cdirs/m4958/usr/aritra08/supervised_cl_eucaif/results/supervised_contrastive/sm_only_v3/embeddings/z_embeddings_all_events.npz"
OUT_DIR = "/global/cfs/cdirs/m4958/usr/aritra08/supervised_cl_eucaif/results/supervised_contrastive/sm_only_v3/linear_probe"
...
def train_linear_probe():
    ...
    print(f"Train dataset: {z_train.shape[0]} events, Test dataset: {z_test.shape[0]} events")
    ...
    axes[0].set_title(f"Classifier accuracy (D={latent_dim})")
    axes[0].legend()
    ...
    fig.tight_layout()
    plot_path = os.path.join(OUT_DIR, "classifier_results.png")
    ...
    results_path = os.path.join(OUT_DIR, "classifier_results.json")
