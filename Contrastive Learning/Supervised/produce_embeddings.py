# Creates the embeddings for the supervised contrastive learning case
...
from pretrain_supervised_contrastive import (
...
CKPT_DIR = "/global/cfs/cdirs/m4958/usr/aritra08/supervised_cl_eucaif/results/supervised_contrastive/sm_only_v3/checkpoints"
ENCODER_CKPT = os.path.join(CKPT_DIR, "encoder_supervised_simclr.pt")
SCALER_CKPT = os.path.join(CKPT_DIR, "scaler.pkl")

OUT_DIR = "/global/cfs/cdirs/m4958/usr/aritra08/supervised_cl_eucaif/results/supervised_contrastive/sm_only_v3/embeddings"
