# Supervised classification using a single linear layer for ssl contrastive learning case
...
EMBEDDINGS_PATH = "/global/cfs/cdirs/m4958/usr/aritra08/ssl_eucaif/results/ssl_contrastive/sm_only_v3/embeddings/z_embeddings_all_events.npz"
OUT_DIR = "/global/cfs/cdirs/m4958/usr/aritra08/ssl_eucaif/results/ssl_contrastive/sm_only_v3/linear_probe"
...
def train_linear_probe():
    ...
    print(f" Train dataset: {z_train.shape[0]} events, and Test dataset: {z_test.shape[0]} events")
